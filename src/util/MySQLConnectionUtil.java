...
public class MySQLConnectionUtil {
	//오라클 연결하는 메소드를 작성. - 리턴 타입 Connection
	public static Connection connect() {
		Connection conn = null;

		String url = "jdbc:mysql://localhost:3306/jcpdev?useSSL = false";   //데이터베이스 URL - 디비버에서 확인가능합니다.
		String driver="com.mysql.cj.jdbc.Driver";     //오라클 드라이버클래스(패키지명.클래스명)
	...
	//                                                    ㄴ    인터페이스 Connection 타입으로 참조합니다.
			...
			conn.setAutoCommit(false);	// 직접 commit
