...
<c:if test="${alert!=null}">
   <script type="text/javascript">
			...
			<table style="width: 100%">
				...
				<tr>
					...
					<td><select name="addr" id="addr_select">
							...
							value="${cus.addr}" placeholder="기타 지역을 입력하세요.">
					</span></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<input type= "button" value="고객목록" onclick="location.href='mybatis_test.jsp'"> 
	...
	<script type="text/javascript">
		document.getElementById("addr_select").addEventListener("change",
				function() {
